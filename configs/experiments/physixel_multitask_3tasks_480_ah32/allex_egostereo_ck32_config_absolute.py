# Modality config for ALLEX robot with egostereo cameras and 32-step action horizon.
...
allex_egostereo_ck32_config_absolute = {
...
register_modality_config(allex_egostereo_ck32_config_absolute, embodiment_tag=EmbodimentTag.NEW_EMBODIMENT)
