# Variant: n15_cylinder_tube_pick_7cm_left
...
DATASET_NAME=v4_cylinder_tube_pick_7cm_left_224
DATA_CONFIG=allex_thetwo_ck40_egostereo

TASK_NAME=task-Cylinder_Tube_Pick-T15cmC7cmLeft
INSTRUCTION="Lift up the cylinder with your left hand, making sure not to touch the tube."
