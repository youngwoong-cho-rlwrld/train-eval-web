# Experiment: dexjoco_gam_kpbottleneck_bimanual_5tasks_224
...
TRAIN_GIT_COMMIT=0fe7b904593e3662cce2a19c40b628c852e6eccd
...
TRAIN_NOTE="DexJoCo 5-task bimanual multitask - GAM 224x224 + keypoint action bottleneck (kp_dim 126, camera-front), kp-augmented datasets"
