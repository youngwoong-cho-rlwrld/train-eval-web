# Experiment: dexjoco_physixel_hammer_nail
# DexJoCo hammer_nail - physixel (single-arm). Train + eval; pick the phase at submit.
...
TRAIN_NOTE="DexJoCo hammer_nail - physixel 256x256 (single-arm) [physixel @73f2aeb]"

# ───── datasets ─────
export DATA_DIR="$HOME/workspace/dexjoco_n16/src_v30/dexjoco_lerobot_datasets"
DATASET_NAME=hammer_nail
...
EVAL_BASE_SEED=0
EVAL_SETS=(rand_obj)
# eval: supply EVAL_CHECKPOINT = the finetune output dir for hammer_nail
