# Variant: n15_multitask_3tasks_480
# GR00T N1.5 multi-task fine-tune on 3 V4 sim datasets at 480x640:
#   - Cube_Box-5cmLeft
#   - Cube_Stack-3cmRight
#   - Cylinder_Tube_Place-T15cmC7cmLeft
# Mirrors n15_multitask_3tasks but uses 480x640 source datasets.
...
TRAIN_BATCH_SIZE=64
TRAIN_EXTRA_ARGS=()
TRAIN_NOTE="N1.5 multi-task @ 480x640 on 3 sim datasets, equal weight=1.0"
