# Experiment: dexjoco_physixel_bimanual_photograph
# DexJoCo bimanual_photograph - physixel (dual-arm). Train + eval; pick the phase at submit.
...
TRAIN_NOTE="DexJoCo bimanual_photograph - physixel 256x256 (dual-arm) [physixel @73f2aeb]"

# ───── datasets ─────
export DATA_DIR="$HOME/workspace/dexjoco_n16/src_v30/dexjoco_lerobot_datasets"
DATASET_NAME=bimanual_photograph
...
EVAL_BASE_SEED=0
EVAL_SETS=(rand_obj)
# eval: supply EVAL_CHECKPOINT = the finetune output dir for bimanual_photograph
