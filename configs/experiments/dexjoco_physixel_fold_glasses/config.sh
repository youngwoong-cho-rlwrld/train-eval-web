# Experiment: dexjoco_physixel_fold_glasses
# DexJoCo fold_glasses - physixel (single-arm). Train + eval; pick the phase at submit.
...
TRAIN_NOTE="DexJoCo fold_glasses - physixel 256x256 (single-arm) [physixel @73f2aeb]"

# ───── datasets ─────
export DATA_DIR="$HOME/workspace/dexjoco_n16/src_v30/dexjoco_lerobot_datasets"
DATASET_NAME=fold_glasses
...
EVAL_BASE_SEED=0
EVAL_SETS=(rand_obj)
# eval: supply EVAL_CHECKPOINT = the finetune output dir for fold_glasses
