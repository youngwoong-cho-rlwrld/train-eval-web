# Variant: n15_cylinder_tube_pick_5cm_right_480
...
DATASET_NAME=v4_cylinder_tube_pick_5cm_right_480
DATA_CONFIG=allex_thetwo_ck40_egostereo

TASK_NAME=task-Cylinder_Tube_Pick-T15cmC5cmRight
INSTRUCTION="Lift up the cylinder with your right hand, making sure not to touch the tube."
