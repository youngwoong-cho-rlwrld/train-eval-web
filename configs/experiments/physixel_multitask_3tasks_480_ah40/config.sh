# Experiment: physixel_multitask_3tasks_480_ah40
# PhysiXel multi-task fine-tune on 3 V4 sim datasets at 480x640, action horizon 40.
...
TRAIN_BATCH_SIZE=64
TRAIN_EXTRA_ARGS=()
TRAIN_NOTE="PhysiXel multi-task @ 480x640 on 3 sim datasets, action horizon 40"
